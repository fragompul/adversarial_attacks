...
# Sidebar Controls
selected_model = st.sidebar.selectbox("Select CNN Architecture", ['MobileNetV2', 'EfficientNetB0', 'InceptionV3'], help="Explore the unique 3D error topology (loss landscape) generated by this specific neural network.")
...
uploaded_file = st.sidebar.file_uploader("Upload an Image", type=["jpg", "jpeg", "png"], help="The starting coordinate in the loss landscape. Notice how the 'mountains' of error change depending on the input image.")
